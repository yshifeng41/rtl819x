...
MIBDEF(unsigned char,	tr069WanMacAddr, [6],	TR069_WAN_MAC_ADDR,	BYTE6_T, APMIB_T, 0, 0)
MIBDEF(unsigned char,	tr069WanDhcp,	,	TR069_WAN_DHCP,	BYTE_T, APMIB_T, 0, 0)
MIBDEF(unsigned char,	tr069WanIpAddr, [4],	TR069_WAN_IP_ADDR,	IA_T, APMIB_T, 0, 0)
MIBDEF(unsigned char,	tr069WanSubnetMask, [4],	TR069_WAN_SUBNET_MASK,	IA_T, APMIB_T, 0, 0)
MIBDEF(unsigned char,	tr069WanDefaultGateway, [4],	TR069_WAN_DEFAULT_GATEWAY,	IA_T, APMIB_T, 0, 0)
MIBDEF(unsigned short,	tr069FixedIpMtuSize, ,	TR069_FIXED_IP_MTU_SIZE,	WORD_T, APMIB_T, 0, 0)

MIBDEF(unsigned char,	tr069HostName, [MAX_NAME_LEN],	TR069_HOST_NAME,	STRING_T, APMIB_T, 0, 0)
MIBDEF(unsigned short,	tr069DhcpMtuSize, ,	TR069_DHCP_MTU_SIZE,	WORD_T, APMIB_T, 0, 0)



MIBDEF(unsigned char,	tr069pppUserName, [MAX_NAME_LEN_LONG],	TR069_PPP_USER_NAME,	STRING_T, APMIB_T, 0, 0)
MIBDEF(unsigned char,	tr069pppPassword, [MAX_NAME_LEN_LONG],	TR069_PPP_PASSWORD,	STRING_T, APMIB_T, 0, 0)
MIBDEF(unsigned char,	tr069ServiceName, [41],	TR069_PPP_SERVICE_NAME,	STRING_T, APMIB_T, 0, 0)

MIBDEF(unsigned short,	tr069pppIdleTime,	,	TR069_PPP_IDLE_TIME,	WORD_T, APMIB_T, 0, 0)
MIBDEF(unsigned short,	tr069pppMtuSize, ,	TR069_PPP_MTU_SIZE,	WORD_T, APMIB_T, 0, 0)

MIBDEF(unsigned char,	tr069pppConnectType,	,	TR069_PPP_CONNECT_TYPE,	BYTE_T, APMIB_T, 0, 0)

MIBDEF(DNS_TYPE_T,		tr069dnsMode,	,	TR069_DNS_MODE,	BYTE_T, APMIB_T, 0, 0)
MIBDEF(unsigned char,	tr069dns1,	[4],	TR069_DNS1,	IA_T, APMIB_T, 0, 0)
MIBDEF(unsigned char,	tr069dns2,	[4],	TR069_DNS2,	IA_T, APMIB_T, 0, 0)
MIBDEF(unsigned char,	tr069dns3,	[4],	TR069_DNS3,	IA_T, APMIB_T, 0, 0)
