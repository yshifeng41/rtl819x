/*
  *  RTL8197B header file of ev_tools
  *
  *	Copyright (C)2008, Realtek Semiconductor Corp. All rights reserved.
  *
  *	$Id: ev_tools.h,v 1.7 2011/01/12 13:05:11 brian Exp $
  */
...
#define PROG_NAME					    ("ev_tools")
#define COPYRIGHT						("Copyright (c) 2008 Realtek Semiconductor Corp.")
#define BIT(x)							(1 << (x))

#define PID_FILE						("/var/ev_tools.pid")
#define CMD_FILE						("/tmp/ev_tools.cmd")
